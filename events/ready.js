...
class Ready extends Index.EntryPoint {
    ...
    call() {
        if (!this.initiated) return new Err(`Called ready event without initialisation!`, `EVTRDYNOINIT`, { instance: this, class: Ready });
        // Call ready event
        this.InLog(`Client online as ${this.client.user.tag}!`);
        this.cache.push(new Cache(`Client logged in and online!`, { client: this.client }));
    }
